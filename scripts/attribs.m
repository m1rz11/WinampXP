...
#define CUSTOM_PAGE "{26E26669-AECA-6633-B8F1-F4A5BF6A6ED5}"
...
#define CUSTOM_PAGE_SONGTICKER "{37ae9a8d-a21c-4b92-8cec-72002bd76244}"
...
Global ScrollingAttribute songticker_scrolling_modern_attrib;
Global ScrollingAttribute songticker_scrolling_classic_attrib;
...
initAttribs() {
	...
	//ConfigItem custom_page = Config.newItem("Winamp Classic Modern", CUSTOM_PAGE);
  ...
  //ConfigItem custom_page_notifier = Config.newItem("Notifications", CUSTOM_PAGE_NOTIFIER);
	...
	//ConfigAttribute submenuattrib = custom_options_page.newAttribute("Winamp Classic Modern", "");
	//submenuattrib.setData(CUSTOM_PAGE); // discard any default value and point at our custom cfgpage

	ConfigAttribute songtickersubmenu = custom_options_page.newAttribute("Songticker", "");
